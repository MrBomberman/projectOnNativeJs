...
function modalWindow() {
  var btnCallMeasurer = document.querySelector('.popup_engineer_btn');
  ...
  btnCallMeasurer.addEventListener('click', function () {
  ...
  modal.addEventListener('click', function (e) {
    ...
    if (e.target === modal || e.target.matches('.popup_engineer .popup_close') == '') {
